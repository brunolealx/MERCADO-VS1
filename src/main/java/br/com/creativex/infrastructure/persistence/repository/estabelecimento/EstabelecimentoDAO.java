...
public class EstabelecimentoDAO {
    ...
    public Estabelecimento carregarDados() throws SQLException {
        ...
        try (Connection conn = Conexao.getConnection();
            ...
            if (rs.next()) {
                ...
                est.setNomeFantasia(getStringIfExists(rs, "nome_fantasia"));
    ...
    public void salvar(Estabelecimento est) throws SQLException {
        String deleteSql = "DELETE FROM tabela_estabelecimento";
        String insertSql = "INSERT INTO tabela_estabelecimento (razao_social, nome_fantasia, cnpj, inscricao_estadual, logradouro, numero, bairro, cidade, estado, cep, codigo_municipio_ibge, regime_tributario, aliq_ibpt) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
